...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `m2a-semantic-option-sft` | implementation | `qwen35-4b-medcmr-b0` | debug | supervised objective / Tier2 | `pilot_ready` | Replaces answer-letter targets with option text to remove the confirmed label shortcut while preserving medical-domain adaptation | 2-step smoke passed: finite, 2 applied steps, 4/4 reload option-text parses, 6.9 GiB peak | run frozen seed3/128 original+rotated PMC pilot; SLAKE only after PMC gates |
