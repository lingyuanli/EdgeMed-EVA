...
| 2 | `m1b-evidence-sft` | brief | `qwen35-4b-medcmr-b0` | explore | supervised objective / Tier2 | `slake_admitted_pmc_pending` | Largest plausible capability gain, especially on LTG, while enabling evidence metrics | SLAKE 1,053-row external manifest passed; PMC train/dev source download and admission still pending | hold until PMC manifests pass provenance/overlap QA |
