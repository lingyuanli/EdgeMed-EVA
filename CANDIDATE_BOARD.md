...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `m1a-answer-qlora` | implementation | `qwen35-4b-medcmr-b0` | exploit | supervised objective / Tier2 | `frozen_for_test` | Tests whether admitted external medical MCQs improve domain answer alignment on one V100 | 3/3 positive; seed3/128 66.0156%; 512 steps did not improve it | freeze seed3/128 and consume one best-SFT Med-CMR MCQ milestone evaluation |
