...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `a1-semantic-order-consensus` | brief | `m2a-semantic-option-sft` | explore | Agent/controller / Tier2 | `designing` | Uses frozen M2a across all cyclic option views and votes by semantic option identity, targeting order sensitivity without further weight tuning | n/a | preregister order-independent aggregation and compute gate; run only missing views |
