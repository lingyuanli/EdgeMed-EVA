...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `transfer-failure-20260902` | analysis | `m1a-answer-qlora` | debug | evaluation/data view / Tier1 | `slice_b_running` | Distinguishes cross-source semantic retention from same-source/letter-token shortcuts without reopening Med-CMR | SLAKE exact +8.6420 and F1 +5.5843 with paired CIs positive; PMC option rotation active | complete label-invariance slice; use result to choose semantic-objective redesign versus source-diverse gate |
