...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `m2b-order-augmented-semantic-sft` | implementation | `m2a-semantic-option-sft` | debug | training data view / Tier2 | `designing` | Keeps the successful option-text objective and decorrelates answer content from fixed letter positions using deterministic training-only rotations | n/a | implement and audit one frozen augmentation; compare against reused B0 semantic outputs |
