...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `transfer-failure-20260902` | analysis | `m1a-answer-qlora` | debug | evaluation/data view / Tier1 | `slice_a_full_running` | Distinguishes cross-source semantic retention from same-source/letter-token shortcuts without reopening Med-CMR | B0/M1a answer-only smoke both 32/32 parseable; 1,053-row full slice active; PMC rotation implementation ready | finish SLAKE retention, then launch frozen rotation slice |
