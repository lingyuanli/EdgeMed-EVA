...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `m1a-answer-qlora` | implementation | `qwen35-4b-medcmr-b0` | explore | supervised objective / Tier2 | `pilot_queued` | Tests whether 1,968 admitted external medical MCQs can improve domain answer alignment on one V100 | backward/save and 4-row adapter reload gates passed; efficacy not yet measured | run frozen 128-step pilot and paired 512-row dev comparison |
