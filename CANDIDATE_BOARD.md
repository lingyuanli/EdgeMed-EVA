...
| 2 | `m1b-evidence-sft` | brief | `qwen35-4b-medcmr-b0` | explore | supervised objective / Tier2 | `source_frozen` | Largest plausible capability gain, especially on LTG, while enabling evidence metrics | PMC train seed, disjoint 512-MCQ dev, and SLAKE cross-dataset sources frozen; no manifest admitted yet | hold until manifests pass provenance/overlap QA |
