...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `m2b-order-augmented-semantic-sft` | implementation | `m2a-semantic-option-sft` | debug | training data view / Tier2 | `pilot_running` | Keeps the successful option-text objective and decorrelates answer content from fixed letter positions using deterministic training-only rotations | surface balance gate and V100 smoke passed; one seed3/128 pilot active from commit `30ec7e0` | complete original/rotated/consistency gate; SLAKE only if all checks pass |
