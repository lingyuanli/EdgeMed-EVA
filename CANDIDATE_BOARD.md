...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `transfer-failure-20260902` | analysis | `m1a-answer-qlora` | debug | evaluation/data view / Tier1 | `slice_a_running` | Distinguishes cross-source semantic retention from same-source/letter-token shortcuts without reopening Med-CMR | SLAKE B0 run active; answer-preserving PMC rotation implementation ready | finish SLAKE retention, then launch frozen rotation slice |
