...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `m1a-answer-qlora` | implementation | `qwen35-4b-medcmr-b0` | explore | supervised objective / Tier2 | `backward_smoke_passed` | Tests whether 1,968 admitted external medical MCQs can improve domain answer alignment on one V100 | 2 finite/applied optimizer steps; peak 6,775 MiB; adapter hash saved under final commit | reload adapter, then run bounded pilot and paired dev comparison |
